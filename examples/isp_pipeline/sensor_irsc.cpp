 ...
 * ===========================================================================
 * 功能描述
 *   - 本文件是 sensor_irsc.hpp 的实现 TU。当前 WorkerBase/DemoWorkerBase
 *     CRTP、IrscWorker / UsbDmaWorker / CmdDmaWorker 与 IrscDriverAo 的
 ...
 *     TU 出现在最终镜像中。
 *   - 依赖：sensor_irsc.hpp 暴露的全部 IRSC 产帧 / 驱动命令 / worker 骨架
 *     API；语义不增不减。
 *
