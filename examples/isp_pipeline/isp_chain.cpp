 ...
 *     EnhanceAO / TempChainAO（FusedNode）以及 CompletionWorkerBase 派生的
 *     IspIrqWorker / SoutDmaWorker / MipiIrqWorker 三个非 AO worker 的
 *     action 与骨架全部为模板可见 /
 ...
 *     Sig / DdrCtx / CompletionWorkerBase / g_pal / PoolT / Rt 等词汇）；不直接
 *     include 其他业务文件。
